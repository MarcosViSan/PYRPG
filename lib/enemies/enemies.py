...
class EnemyLvl1():
    ...
    def __init__(self, pos: tuple, fps) -> None:
        ...
        self.animation['attacking'].eventPoints["attack"] = 3
...
class EnemyLvl2():
    ...
    def __init__(self, pos: tuple, fps) -> None:
        ...
        standingFrames = ['' for i in range(4)]
        standingFrames[0] = pygame.transform.scale_by(pygame.image.load("assets\\enemies-sprites\\3\\standing\\standing-1.png").convert_alpha(), 2.0)
        standingFrames[1] = pygame.transform.scale_by(pygame.image.load("assets\\enemies-sprites\\3\\standing\\standing-2.png").convert_alpha(), 2.0)
        standingFrames[2] = pygame.transform.scale_by(pygame.image.load("assets\\enemies-sprites\\3\\standing\\standing-3.png").convert_alpha(), 2.0)
        standingFrames[3] = pygame.transform.scale_by(pygame.image.load("assets\\enemies-sprites\\3\\standing\\standing-4.png").convert_alpha(), 2.0)

        attackingFrames = ['' for i in range(6)]
        attackingFrames[0] = pygame.transform.scale_by(pygame.image.load("assets\\enemies-sprites\\3\\attack\\attack-1.png").convert_alpha(), 2.0)
        attackingFrames[1] = pygame.transform.scale_by(pygame.image.load("assets\\enemies-sprites\\3\\attack\\attack-2.png").convert_alpha(), 2.0)
        attackingFrames[2] = pygame.transform.scale_by(pygame.image.load("assets\\enemies-sprites\\3\\attack\\attack-3.png").convert_alpha(), 2.0)
        attackingFrames[3] = pygame.transform.scale_by(pygame.image.load("assets\\enemies-sprites\\3\\attack\\attack-4.png").convert_alpha(), 2.0)
        attackingFrames[4] = pygame.transform.scale_by(pygame.image.load("assets\\enemies-sprites\\3\\attack\\attack-5.png").convert_alpha(), 2.0)
        attackingFrames[5] = pygame.transform.scale_by(pygame.image.load("assets\\enemies-sprites\\3\\attack\\attack-6.png").convert_alpha(), 2.0)

        deathFrames = ['' for i in range(6)]
        deathFrames[0] = pygame.transform.scale_by(pygame.image.load("assets\\enemies-sprites\\3\\death\\death-1.png").convert_alpha(), 2.0)
        deathFrames[1] = pygame.transform.scale_by(pygame.image.load("assets\\enemies-sprites\\3\\death\\death-2.png").convert_alpha(), 2.0)
        deathFrames[2] = pygame.transform.scale_by(pygame.image.load("assets\\enemies-sprites\\3\\death\\death-3.png").convert_alpha(), 2.0)
        deathFrames[3] = pygame.transform.scale_by(pygame.image.load("assets\\enemies-sprites\\3\\death\\death-4.png").convert_alpha(), 2.0)
